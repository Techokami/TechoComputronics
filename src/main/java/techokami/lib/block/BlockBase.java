...
public abstract class BlockBase extends BlockContainer {
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9) {
		...
		if(!world.isRemote) {
			...
			if(held != null && held.getItem() != null && TechoLibMod.integration.isWrench(held.getItem()) && this.rotation != null) {
				boolean wrenched = TechoLibMod.integration.wrench(held.getItem(), player, x, y, z);
